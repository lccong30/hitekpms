    ...
    <div className="container">
      <div className="md:flex flex flex-col-reverse lg:flex-row  justify-between py-[90px] md:py-[150px]   ">
        <div className=" w-full lg:w-[45%] flex flex-col gap-5  md:gap-10">
          <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mt-[40px] md:mt-[100px]  animate__animated animate__fadeInDown">
            HiTek PMS <br />
            Sự lựa chọn hoàn hảo cho quản lý tòa nhà thông minh.
          </h1>
          <p className="text-base font-medium text-gray-500 md:text-xl animate__animated animate__fadeInLeft">
          ...
          <div>
            <div className="flex gap-3 p-2 border border-black rounded animate__animated animate__fadeInUp">
              <input
                type={"email"}
                required
        ...
        <img
          className=" w-full mt-5 md:mt-0 lg:w-[49%] object-contain animate__animated  animate__headShake"
          src={Banner2}
          alt=""
        />
      </div>
